...
# it includes:
- S3: Handling the front-end
- EB: handling the back-end
- RDS: Creating "POSTGRES database"
- CircleCI: A Pipeline creation for Continuous integration & Continuous deployment(CI / CD)
